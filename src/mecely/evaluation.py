...
instead, never inventing facts the source case doesn't provide. That
needs the full case text available to the prompt, not just the
one-paragraph `prompt` field, so it isn't handled here yet.
"""
